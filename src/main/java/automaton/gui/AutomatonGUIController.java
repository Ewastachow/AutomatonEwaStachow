...
import automaton.core.GameOfLife;
import automaton.core.LangtonAnt;
import automaton.core.OneDim;
import automaton.core.WireWorld;
...
public class AutomatonGUIController extends Observable {
    ...
    void gameOfLifeToggleButtonAction(ActionEvent event) {
        currentState.automatonClass = GameOfLife.class;
    ...
    void langtonAntToggleButtonAction(ActionEvent event) {
        currentState.automatonClass = LangtonAnt.class;
        setButton();
        timeline.stop();
        resetCells(currentState.width, currentState.height, currentState.cells);
        currentState.start();
    ...
    void wireworldToggleButtonAction(ActionEvent event) {
        currentState.automatonClass = WireWorld.class;
        setButton();
        timeline.stop();
        resetCells(currentState.width, currentState.height, currentState.cells);
        currentState.start();
    ...
    void oneDimToggleButtonAction(ActionEvent event) {
        currentState.automatonClass = OneDim.class;
        setButton();
        timeline.stop();
        resetCells(currentState.width, currentState.height, currentState.cells);
        currentState.start();
